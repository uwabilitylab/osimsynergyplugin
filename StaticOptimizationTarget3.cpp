/* -------------------------------------------------------------------------- *
*                   OpenSim:  StaticOptimizationTarget3.cpp                   *
* -------------------------------------------------------------------------- *
...
const double StaticOptimizationTarget3::SMALLDX = 1.0e-14;
//const double StaticOptimizationTarget3::_activationExponent = 2.0;
...
// CONSTRUCTION
//==============================================================================
bool StaticOptimizationTarget3::
...
* @param aModel Model.
*/
void StaticOptimizationTarget3::
...
*/
double StaticOptimizationTarget3::
getDX(int aIndex)
{
...
{
	if (aSize<SMALLDX) {
		printf("StaticOptimizationTarget3.validatePerturbationSize: WARNING- ");
...
*/
int StaticOptimizationTarget3::
CentralDifferencesConstraint(const StaticOptimizationTarget3 *aTarget,
...
*/
int StaticOptimizationTarget3::
CentralDifferences(const StaticOptimizationTarget3 *aTarget,
...
computeConstraintVector(SimTK::State& s, const Vector &parameters, Vector &constraints) const
{
	...
	for (int i = 0; i<getNumConstraints(); i++) {
		...
		if (ind < 0) {
			...
			if (ind < 0) {
				string msg = "StaticOptimizationTarget3::computeConstraintVector: \n";
...
constraintJacobian(const SimTK::Vector &parameters, const bool new_parameters, SimTK::Matrix &jac) const
{
	...
	// Compute gradient 
	StaticOptimizationTarget3::CentralDifferencesConstraint(this, &_dx[0], parameters, jac);
