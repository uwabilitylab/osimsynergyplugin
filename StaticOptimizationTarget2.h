#ifndef _StaticOptimizationTarget2_h_
#define _StaticOptimizationTarget2_h_
/* -------------------------------------------------------------------------- *
 *                    OpenSim:  StaticOptimizationTarget2.h                    *
 * -------------------------------------------------------------------------- *
 ...
 */
class StaticOptimizationTarget2 : public SimTK::OptimizerSystem
{
//=============================================================================
// DATA
//=============================================================================
...
//=============================================================================
public:
	StaticOptimizationTarget2(const SimTK::State& s, Model *aModel,int aNX,int aNC, const bool useMusclePhysiology=true);
...
#endif // _StaticOptimizationTarget2_h_
