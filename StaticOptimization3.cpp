/* -------------------------------------------------------------------------- *
*                      OpenSim:  StaticOptimization3.cpp                      *
* -------------------------------------------------------------------------- *
...
* Destructor.
*/
StaticOptimization3::~StaticOptimization3()
{
	deleteStorage();
...
/**
*/
StaticOptimization3::StaticOptimization3(Model *aModel) :
	Analysis(aModel),
...
*
*/
StaticOptimization3::StaticOptimization3(const StaticOptimization3 &aStaticOptimization3) :
	Analysis(aStaticOptimization3),
...
*/
StaticOptimization3& StaticOptimization3::
operator=(const StaticOptimization3 &aStaticOptimization3)
{
	// BASE CLASS
	Analysis::operator=(aStaticOptimization3);

	_modelWorkingCopy = aStaticOptimization3._modelWorkingCopy;
	_numCoordinateActuators = aStaticOptimization3._numCoordinateActuators;
	...
	_forceReporter = nullptr;
	_useMusclePhysiology = aStaticOptimization3._useMusclePhysiology;
	return(*this);
}
...
*/
int StaticOptimization3::begin(const SimTK::State& s)
{
	if (!proceed()) return(0);
...
* @return -1 on error, 0 otherwise.
*/
int StaticOptimization3::step(const SimTK::State& s, int stepNumber)
{
...
* @return -1 on error, 0 otherwise.
*/
int StaticOptimization3::end(const SimTK::State& s)
{
	if (!proceed()) return(0);
