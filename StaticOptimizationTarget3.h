#ifndef _StaticOptimizationTarget3_h_
#define _StaticOptimizationTarget3_h_
/* -------------------------------------------------------------------------- *
*                    OpenSim:  StaticOptimizationTarget3.h                    *
* -------------------------------------------------------------------------- *
...
namespace OpenSim {
	...
	*/
	class OSIMPLUGIN_API StaticOptimizationTarget3 : public SimTK::OptimizerSystem
	{
		//=============================================================================
		// DATA
		//=============================================================================
	...
	protected:
		...
		//=============================================================================
	public:
		StaticOptimizationTarget3(const SimTK::State& s, Model *aModel, int aNX, int aNC, const bool useMusclePhysiology = true);
...
#endif // _StaticOptimizationTarget3_h_